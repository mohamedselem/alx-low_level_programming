...
/**
 * struct hash_node_s - func of Node of a hash table
 * @key: The key, string
...
/**
 * struct hash_table_s - func to Hash table data structure
...
/**
 * struct shash_node_s - func of Node of a sorted hash table
 * @key: The key, string
...
/**
 * struct shash_table_s - func to Sorted hash table data structure
 * @size: The size of the array
 * @array: An array of size @size
